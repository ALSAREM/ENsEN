...
import ensen.control.DBpediaLookupClient;
...
import ensen.control.WordNetManager;
...
public class Query {
	...
	public void extendQueryLexicaly() {
		...
		System.out.println("extendQueryLexicaly:");
		while (It.hasNext()) {
			String str = It.next();
		...
		//System.out.println();
		System.out.println("fin of extendQueryLexicaly:");
		ExtendedText += Text;
