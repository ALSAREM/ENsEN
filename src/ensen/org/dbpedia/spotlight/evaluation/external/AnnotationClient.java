...
public abstract class AnnotationClient {
	...
	public String request(HttpMethod method) throws AnnotationException {
		...
		try {
			...
			InputStream responseBodyStream = method.getResponseBodyAsStream(); //TODO Going to buffer response body of large or unknown size. Using getResponseBodyAsStream instead is recommended.
